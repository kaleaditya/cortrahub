            ...
            <div class="card-body">
                ...
                <tbody>
                    ...
                    <tr class="flexTbl">
                        ...
                        <td><span class="mobileShow">User :</span> {{ $row->member->name }}</td>
                        <td>
                            <div class="ThreeBtns">
                             <form action="{{ route('wishlist.destroy', $row->id) }}" method="POST" class="d-inline">
                                @csrf
                                @method('DELETE')
                                <button type="submit" class="bi bi-trash btn btn-outline-danger btn-sm"
                                    onclick="return confirm('Are you sure you want to remove this item from the wishlist?')">
                                </button>
                            </form>
        ...
        buttons: [

            {
                ...
                action: function(e, dt, node, config) {
                    window.location.href = "#";  // Redirect to the order creation route
                }
            }
        ],
        language: {
