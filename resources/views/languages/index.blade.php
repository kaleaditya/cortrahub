            ...
            <div class="card-body">
                ...
                <tbody>
                    ...
                    <tr class="flexTbl">
                        ...
                        <td><span class="mobileShow">Language :</span> {{ $item->title }}</td>
                         <td>
                            @if ($item && $item->is_active)
                            <a href="{{route('language.status',$item->id)}}" onclick="return confirm('Are you sure?')"><span class="badge bg-success">Active</span></a>
                            @else
                            <a href="{{route('language.status',$item->id)}}" onclick="return confirm('Are you sure?')"><span class="badge bg-danger">Inactive</span></a>
                            @endif
                        </td>
