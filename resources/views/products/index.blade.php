                    ...
                    <tr class="flexTbl">
                        ...
                        <td><span class="mobileShow">Product :</span>  {{ optional($item->role)->name }}</td>
                         ...
                         <td>
                            ...
                            <a href="{{route('product.status',$item->id)}}" onclick="return confirm('Are you sure?')"><span class="badge bg-success">Active</span></a>
                            @else
                            <a href="{{route('product.status',$item->id)}}" onclick="return confirm('Are you sure?')"><span class="badge bg-danger">Inactive</span></a>
                            @endif
                        </td>
        ...
        buttons: [
            ...
            // },
            {
                ...
                action: function(e, dt, node, config) {
                    window.location.href = "{{ route('products.create') }}";  // Redirect to the order creation route
                }
            }
        ],
        language: {
