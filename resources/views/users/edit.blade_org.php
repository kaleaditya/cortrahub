                    ...
                    <div class="row">
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <input type="url" name="youtube" placeholder="Enter youtube channel" class="form-control" value="{{ old('youtube', $user->youtube) }}" pattern="[0-9]{10}" >
                            </div>
                        </div>
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <p>Maximum image size 25 kb (400 px X 400 px)</p>
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <select name="other[]" class="form-control   open-dropdown required" required multiple>
