        ...
        <div class="card cardPdd">
                ...
                <div class="col-lg-12 margin-tb">
                    <div class="flexBdy">
                        <div class="pull-left">
                            ...
                            <h5 class="card-title">{{$role}} Trainer</h5>
                        </div>
            ...
            <div class="frmGrp">
                <form id="userform" method="POST" action="{{ route('users.update', $user->id) }}" enctype="multipart/form-data">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                <strong class="strng required-label">Name: </strong>
                        ...
                        <div class="col-md-4">
                          ...
                          <div class="col-md-12">
                            <div class="form-group">
                                <strong class="strng required-label">Detailed Profile Description: </strong>
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <select name="state_id" id="state" class="form-control required" required>
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <input type="number" name="age" placeholder="Exposure in Years" class="form-control required" value="{{ old('age', $user->age) }}" min="1" max="120" required>
                            </div>
                        </div>
                        <div class="col-md-4">
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <select name="language[]" class="form-control open-dropdown required" multiple required>
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                <strong class="strng required-label">Profile  Image:(Dimension:400x400px)(File-Type.jpg) </strong>
                                <input type="file" name="image" class="form-control" accept="image/*">
                                <input type="hidden" name="old_image" value="{{ $user->image }}">
                                @if($user->image)
                                    <img src="{{ asset('all_image/' . $user->image) }}" alt="{{$user->name}}: Profile Picture" style="max-width: 100px; margin-top: 10px;">
                                @endif
                            </div>
                        </div>
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                <strong class="strng ">Detail Header Image (Dimension:830px x 320px)(File-Type.jpg) </strong>
                                <input type="file" name="header_image" class="form-control" accept="image/*">
                                <input type="hidden" name="old_header_image" value="{{  $user->header_image }}">
                                @if($user->header_image)
                                    <img src="{{ asset('all_image/' . $user->header_image) }}" alt="{{$user->name}}: Header Image" style="max-width: 100px; margin-top: 10px;">
                                @endif
                            </div>
                        </div>
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                <strong class="strng ">Ad-Banner Image:(Dimension:830px x 320px)(File-Type.jpg)  </strong>
                                <input type="file" name="banner_image" class="form-control" accept="image/*">
                                <input type="hidden" name="old_banner_image" value="{{ $user->banner_image }}">
                                @if($user->banner_image)
                                    <img src="{{ asset('all_image/' . $user->banner_image) }}" alt="{{$user->name}}: Ad Image" style="max-width: 100px; margin-top: 10px;">
                                @endif
                            </div>
                        </div>
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <select name="experience[]" class="form-control open-dropdown required" multiple required>
                        ...
                        <div class="col-md-8">
                            <div class="form-group">
                                ...
                                <select name="other[]" class="form-control open-dropdown" multiple>
                        ...
                        $selectedOthers = old('other', explode(',', $user->other ?? ''));
                    @endphp

                    @foreach($others as $other)
                        <option value="{{ $other->id }}" {{ in_array($other->id, $selectedOthers) ? 'selected' : '' }}>
                            {{ $other->title }}
                        </option>
                    @endforeach
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <input type="tel" name="whatsup" placeholder="Enter WhatsApp No" class="form-control required" value="{{ old('whatsup', $user->whatsup) }}" pattern="[0-9]{10}" title="Please enter a valid 10-digit WhatsApp number"readonly>
                            </div>
                        </div>
                        <div class="col-md-4">
                            <div class="form-group">
                  ...
                  <div class="col-md-4">
    <div class="form-group">
        <strong class="strng">Introduction Video: </strong>
        <input type="url" name="instagram" placeholder="Enter Introduction Link" class="form-control" value="{{ old('youtube_intro', $user->youtube_intro) }}" pattern="https?://.*" title="Please enter a valid URL">
    </div>
</div>

<div class="col-md-4">
    <div class="form-group">
        <strong class="strng">YouTube Channel Link: </strong>
        <input type="url" name="youtube" placeholder="Enter YouTube Channel Link" class="form-control" value="{{ old('youtube_channel', $user->youtube_channel) }}" pattern="https?://.*" title="Please enter a valid URL">
    </div>
</div>
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <input type="text" name="page_title" placeholder="Your Full Name" class="form-control" value="{{ old('page_title', $user->page_title) }}" >
                            </div>
                        </div>
                        <div class="col-md-4">
                            <div class="form-group">
                                <strong class="strng ">Meta Title: </strong>
                                <input type="text" name="meta_title" placeholder="Name with Profession" class="form-control " value="{{ old('meta_title', $user->meta_title) }}" >
                            </div>
                        </div>
                        <div class="col-md-4">
                            <div class="form-group">
                                <strong class="strng ">Meta Keywords: </strong>
                                <input type="text" name="meta_keyword" placeholder="Keywords of your profession" class="form-control " value="{{ old('meta_keyword', $user->meta_keyword) }}">
                            </div>
                        </div>
                      
                           <!-- <div class="form-group">
                                <strong class="strng">Short Profile : </strong>
                                <textarea name="short_description" class="form-control" rows="3" >{{ old('short_description', $user->short_description) }}</textarea>
                            </div>-->
                            <div class="form-group">
                                <strong class="strng -label">Meta Description: </strong>
                                <textarea name="meta_description" placeholder="A short description about yourself" class="form-control " rows="3" >{{ old('meta_description', $user->meta_description) }}</textarea>
                            </div>
                        </div>
