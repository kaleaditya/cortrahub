            ...
            <div class="frmGrp">
                <form id="userform" method="POST" action="{{ route('users.update', $user->id) }}" enctype="multipart/form-data">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                <strong class="strng required-label">Facebook: </strong>
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                <strong class="strng required-label">Website: </strong>
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <input type="url" name="youtube" placeholder="Enter youtube" class="form-control" value="{{ old('youtube', $user->youtube) }}" pattern="https?://.*" title="Please enter a valid URL">
                            </div>
                        </div>
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                <strong class="strng required-label">Experience in Years: </strong>
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                <strong class="strng required-label">Profile  Image:</strong>
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                <strong class="strng required-label">Detail Header Image: </strong>
                                <input type="file" name="header_image" class="form-control" accept="image/*">
                                <input type="hidden" name="old_header_image" value="{{ $user->image }}">
                                @if($user->image)
                                    <img src="{{ asset('all_image/' . $user->header_image) }}" alt="Current Image" style="max-width: 100px; margin-top: 10px;">
                                @endif
                            </div>
                        </div>
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                <strong class="strng required-label">Ad-Banner Image: </strong>
                                <input type="file" name="banner_image" class="form-control" accept="image/*">
                                <input type="hidden" name="old_banner_image" value="{{ $user->banner_image }}">
                                @if($user->image)
                                    <img src="{{ asset('all_image/' . $user->banner_image) }}" alt="Current Image" style="max-width: 100px; margin-top: 10px;">
                                @endif
                            </div>
                        </div>
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                <strong class="strng required-label">Programs: </strong>
                                <select name="other[]" class="form-control required open-dropdown" required multiple>
                    ...
                    @endforeach
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <input type="text" name="meta_title" class="form-control " value="{{ old('meta_title', $user->meta_title) }}" >
                            </div>
                        </div>
                        <div class="col-md-4">
                            <div class="form-group">
                                <strong class="strng ">Meta Keywords: </strong>
                                <input type="text" name="meta_keyword" class="form-control " value="{{ old('meta_keyword', $user->meta_keyword) }}">
                            </div>
                        </div>
                        <div class="col-md-12">
                            <div class="form-group">
                                <strong class="strng required-label">A Few Words About Yourself: </strong>
                            ...
                            <div class="form-group">
                                ...
                                <textarea name="meta_description" class="form-control " rows="3" >{{ old('meta_description', $user->meta_description) }}</textarea>
                            </div>
                        </div>
