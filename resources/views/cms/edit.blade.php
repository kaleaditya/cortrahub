...
<div class="row">
    <div class="col-lg-12">
        <div class="card cardPdd">
            ...
            <div class="frmGrp">
                <form method="POST" action="{{ route('cms.update', $cms->id) }}" id="cmsForm">
                    @csrf
                    @method('PUT')
                    <div class="row">
                        <!-- BASIC INFO -->
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="text" name="title" value="{{ old('title', $cms->title) }}" placeholder="Enter Title" class="form-control required">
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="form-group">
                                <strong class="strng required-label">Page Title:</strong>
                                <input type="text" name="page_title" value="{{ old('page_title', $cms->page_title) }}" placeholder="Enter Page Title" class="form-control required">
                            </div>
                        </div>
                        ...
                        <div class="col-md-12">
                            <div class="form-group">
                                ...
                                <textarea name="description" id="description" class="form-control required">{{ old('description', $cms->description) }}</textarea>
                            </div>
                        </div>
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="text" name="meta_title" value="{{ old('meta_title', $cms->meta_title) }}" placeholder="Enter Meta Title" class="form-control required">
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="form-group">
                                <strong class="strng required-label">Meta Keywords:</strong>
                                <input type="text" name="meta_keywords" value="{{ old('meta_keywords', $cms->meta_keywords) }}" placeholder="Enter Meta Keywords" class="form-control required">
                            </div>
                        </div>
                        <div class="col-md-12">
                            <div class="form-group">
                                <strong class="strng required-label">Meta Description:</strong>
                                <textarea name="meta_description" id="meta_description" class="form-control required">{{ old('meta_description', $cms->meta_description) }}</textarea>
                            </div>
                        </div>
                        ...
                        <div class="col-md-12">
                            <div class="form-group">
                                ...
                                <input type="checkbox" name="is_active" value="1" {{ old('is_active', $cms->is_active) ? 'checked' : '' }}> Active
                            </div>
                        </div>
