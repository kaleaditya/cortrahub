                ...
                <tbody>
                    ...
                    <tr class="flexTbl">
                        ...
                        <td>
                            ...
                            <form action="{{ route('experiences.destroy', $item->id) }}" method="POST" class="d-inline">
                                @csrf
                                @method('DELETE')
        ...
        buttons: [
            ...
            // },
            {
                ...
                action: function(e, dt, node, config) {
                    window.location.href = "{{ route('experiences.create') }}";  // Redirect to the order creation route
                }
            }
        ],
        language: {
