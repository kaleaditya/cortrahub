...
@section('content')
    ...
    <div class="frmGrp antherGrp">
              <form action="{{ route('teams.store') }}" method="POST" enctype="multipart/form-data" id="item"> @csrf

                <div class="row mb-3">
                  <label for="inputEmail3" class="col-sm-1 col-form-label strng flexCntr"> Name <span class="text-danger">*</span></label>
                  <div class="col-sm-5">
                    <input type="text" name="name" value="{{old('name')}}" class="form-control required" id="inputText">
                   </div>
                </div>
                ...
                <div class="row mb-3">
                  ...
                  <div class="col-sm-5">
                    <input type="text" name="designation" value="{{old('designation')}}" class="form-control required" id="inputText">
                   </div>
                </div>
                ...
                <div class="row mb-3">
                  ...
                  <div class="col-sm-5">
                    <input type="text" name="description" value="{{old('description')}}" class="form-control required" id="inputText">
                   </div>
                </div>  
