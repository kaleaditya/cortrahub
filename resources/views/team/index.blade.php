            ...
            <div class="card-body">
                ...
                <tbody>
                    ...
                    <tr class="flexTbl">
                        ...
                        <td><span class="mobileShow">Name :</span> {{ $item->name }}</td>
                        <td><span class="mobileShow">Designation :</span>  {{$item->designation}}</td>
                        <td><img src="{{asset('all_image/'.$item->image)}}" alt="" height="50" width="50"></td>
                        <td>
                            <div class="ThreeBtns">
                            <a href="{{ route('teams.edit',$item->id) }}" class="bi bi-pencil-square btn btn-outline-primary btn-sm"></a>
        ...
        buttons: [
            ...
            // },
            {
                ...
                action: function(e, dt, node, config) {
                    window.location.href = "{{ route('teams.create') }}";  // Redirect to the order creation route
                }
            }
        ],
        language: {
