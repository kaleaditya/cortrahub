...
class RoleController extends Controller
{
     ...
     * @return \Illuminate\Http\Response
     */
    public function destroy12($id): RedirectResponse
    {
    ...
    public function destroy($id)
{
    ...
    if ($usersWithRole > 0) {
        return redirect()->route('roles.index')
            ->with('error', 'Role cannot be deleted because it is assigned to one or more users. Please change their role first.');
    }
