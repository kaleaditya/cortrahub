...
<script type="text/javascript" charset="utf-8">
	...
	function renderaction(data, type, full)
	{
		...
		}else
		{
			...
			var value = "<a title='Approve' href='javascript:void(0)' onclick='isapprove_telent_aquire("+data+");'><img src='<?= site_url('assets/admin/images/approve.png') ?>'/></a> | <a title='Reject' href='javascript:void(0);' onclick='confirm_reject("+data+");'><img src='<?= site_url('assets/admin/images/reject.png') ?>'/></a>";
		return value;
	...
	function isapprove_telent_aquire(id)
	{
		if (confirm("Are you sure to approve this request?")) {
			
			window.location = '<? echo site_url("admins/new_registration/isapprove_telent_aquire");?>'+"/"+id;
		}
	}
