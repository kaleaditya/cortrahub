<script type="text/javascript">
	...
	function checkcountry()
	{
		...
		{
			type : "POST",
			url:"<?php echo site_url('admins/country/checkcountrybyid');?>",
...
<div id="main">
	<div id="globalTabContent">
		<ul class="tabs-nav">
			...
			<li><a href="<?php echo site_url('admins/country');?>" class="button-big">Back to List View</a></li>
		</ul>
		<div id="tab-1" class="tabs-container">
			<div class="globalContainer">
				...
				<?php echo form_open('admins/country/update','name="form1" id="form1" enctype="multipart/form-data" onsubmit="return checkcountry()"'); ?>
					<table  border="0" cellpadding="5" cellspacing="1" width="100%" class="tblDisplay widthPc">
						...
						<tr class="odd">
							...
							<td>
								<input type="text" name="country" id="country" class="required" value="<?=$detail['country']?>" onblur="checkcountry()" style='width:400px;' maxlength="200" minlength="2">
						...
						<tr class="odd">
							...
							<td>
								...
								<a href="<?php echo site_url('admins/country');?>"><img src='<?php echo site_url('assets/admin/images/cancel.gif');?>' /></a>
							</td>
						</tr> 
					</table>
				<? echo form_close(); ?>
