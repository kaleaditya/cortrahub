...
<div id="main">
	<div id="globalTabContent">
		<ul class="tabs-nav">
			...
			<?php $allimage=$this->gallery_image_gallery_m->get_all_images($directoryid); 
		...
		<div id="tab-1" class="tabs-container">
			<div class="globalContainer">
				...
				<?php echo form_open('admins/directorylist/add_image_gallery','name="form1" id="form1" enctype="multipart/form-data"'); ?>
					<table id="roottable" style="display:none;" cellpadding="5" cellspacing="0" border="0" width="100%" summary="" class="tblDisplay widthPc">
						<tr class="odd">
							<td class="width130" valign="top">Image <span class="highlight">*</span></td>
							<td>
								<input type="file" id="image" name="image[]" class="required" accept=".jpg,.jpeg,.png,.gif" multiple>
								
								[.jpg,.jpeg,.png,.gif Only ] and [ Recommended Size more than or equal to 400px X 350px. ]  <br/>
								<div id="imagemsg"></div>
							</td>
						</tr>
...
<script type="text/javascript">
	...
	{
		var value = "<a target='_blank' href='<?=site_url('userfiles/gallery/photo/medium')?>/"+data+"'><img src='<?=site_url('userfiles/gallery/photo/medium')?>/"+data+"' border='0' width='71px'/></a>";
		if(data=="")
		{
			return "--";
		}
	...
	function confirm_delete(id) 
	{
		...
		if(value)
		{
			window.location = '<? echo site_url("admins/directorylist/delete_image_gallery");?>'+"/"+id+"/"+directoryid;
		}
	}
	...
	$(document).ready(function() 
	{
		$('#example').dataTable(
		{
			...
			"sAjaxSource":"<?php echo site_url('admins/directorylist/get_image_gallery');?>/<?=$directoryid;?>"
			//"sDom": "<''f>t<'F'lp>"
		});
	});
</script>
	...
	$("#image").change(function() 
	{
		...
		switch(val.substring(val.lastIndexOf('.') + 1).toLowerCase())
		{
			...
			default:
				...
				$("#imagemsg").html('.jpg,.jpeg,.png,.gif Only');
				break;
		}
	});
</script>