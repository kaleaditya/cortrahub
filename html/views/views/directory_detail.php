	...
	<div class="row">
        <div class="col-md-12">
			...
			<?php if($this->session->userdata('frontloggedin') == '1' && $this->session->userdata('frontloggedin') != ""){
											...
											<?php }else
											{ ?>
												<a href="javascript:void(0);" class="whislistbtn" onclick="add_wishlist('<?=$directory['id']?>','<?=$this->session->userdata('id')?>');"> Add to list </a>
											<?php }?>
						...
						<div class="col-xs-12 col-sm-12 col-md-12">
							<div class="company-content paddleftrightnone paddbtn0">
								...
								<div class="row no-left-right-margin poi-and-body paddbtm_detail divflex">
									...
									<? if(isset($directory['intro_video']) && $directory['intro_video']!='')
										{?>
										<a class="whislistbtn"  data-toggle="modal" data-target="#introvideo_modal"> Introduction Video </a>
											...
											<iframe type="text/html" height="380" src="<?= $directory['intro_video'];?>" frameborder="0" allowfullscreen="" style="width:100% !important"></iframe>
											</div>
						...
						<div>
							...
							<ul class="nav nav-tabs">
								...
								<? if(count($allproducts) > 0 || count($allservices) > 0)
								   {?>
										<li><a href="#productandservice" aria-controls="productandservice" data-toggle="tab">Languages</a></li>
								 <?}?>
								<? if(count($allspeciality))
								   {?>
										<li><a href="#speciality" aria-controls="speciality" data-toggle="tab">Experience</a></li>
								 <?}?>
