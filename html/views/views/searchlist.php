<script>
    $(document).ready(function () {
		...
		pageurl = "<? echo site_url('ajaxdirectorylist');?>";
		
		$(".pagination > ul li a").on("click",function(e){
				e.preventDefault();				
				GetAjaxsearchList(pageurl);
		});
		...
		$.ajax({				
				type: "POST",
				url:"<? echo site_url('ajaxdirectorylist');?>",
				data: {search_name:search_name,search_location:search_location,search_subcategory:search_subcategory,search_speciality:search_speciality,search_services:search_services,search_products:search_products,search_country:search_country,search_state:search_state,search_ages:search_ages,search_directoryname:search_directoryname},
	...
	function GetAjaxsearchList(pageurl)
	{
			var search_name='<?=$search_name?>';
			var search_location=$("#search_location").val();
			...
			parpage = "<? echo site_url('ajaxdirectorylist');?>"+""+pageurl;
			$.ajax({
				type: "POST",
				url:parpage,
				data: {search_name:search_name,search_location:search_location,search_subcategory:search_subcategory,search_speciality:search_speciality,search_services:search_services,search_products:search_products,search_country:search_country,search_state:search_state,search_ages:search_ages,search_directoryname:search_directoryname},
	...
	function GetAjaxfilterList()
	{
			...
			parpage = "<? echo site_url('ajaxdirectorylist');?>";
			$.ajax({
				type: "POST",
				url:parpage,
				data: {search_name:search_name,search_location:search_location,search_subcategory:search_subcategory,search_speciality:search_speciality,search_services:search_services,search_products:search_products,search_country:search_country,search_state:search_state,search_ages:search_ages,search_directoryname:search_directoryname},
	...
	function GetAjaxclearallList()
	{
			...
			$("#search_state").select2('val','');
			$("#search_location").select2('val',search_location);
