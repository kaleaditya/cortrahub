<?if(count($directorylist))
    ...
    <?php if(($this->session->userdata('frontloggedin') == '1' && $this->session->userdata('intention_of_reg') == '1' && $list['isblock'] == 1) ||
    ($this->session->userdata('frontloggedin') == '' && $list['isblock'] == 1)){ ?>
    <div class="<?=$clss?>">
        ...
        <div class="block_info">
            <div class="padd">
                ...
                <p>This Profile has been locked by request<br> of the member. It can be seen only by<br> Production
                    Houses or Casting Agencies registered with ATOM Directory</p>
            </div>
        </div>
    </div>
        ...
        <div class="row mobile_570">
            <div class="col-xs-4 col-sm-4 col-md-3 col-md-push-9 col-sm-push-8 col-xs-push-8 text-right comp-logo">
                <a href="<? echo site_url('directory_detail');?>/<?=$list['categoryslug'];?>/<?=$list['slug'];?>">
                    <?if($list['image'] != "")
                            { ?>
                    <img src="<?=site_url('userfiles/directorylist/resizeimage').'/'.$list['image']?>" alt=""
                        class="img-responsive dib">
                    <? }
                            else
                            { ?>
                    <img src="<?=site_url('assets/images/ifid_notavailable-128.jpg')?>" alt=""
                        class="img-responsive dib">
                    <? } ?>
                </a>
            </div>
            <div class="col-xs-8 col-sm-8 col-md-9 col-md-pull-3 col-sm-pull-4 col-xs-pull-4">
                <p><span class="bold"><a
                            href="<? echo site_url('directory_detail');?>/<?=$list['categoryslug'];?>/<?=$list['slug'];?>"><?=ucwords($list['name'])?></a></span><br>
                ...
                <p style="color:red;"><a
                        href="<? echo site_url('directory_detail');?>/<?=$list['categoryslug'];?>/<?=$list['slug'];?>">Read
                        More</a></p>
            </div>
                    ...
                    <ul class="list_btm_area">
                        ...
                        <li>
                            <a href="javascript:void(0);" data-toggle="modal" data-target="#myModal2"
                                data-id="<?=$list['mobileno']?>" id="openmobileno">
                                <span
                                    class="glyphicon glyphicon-phone icon-circle border border-dark-blue with-text"></span>Mobile</a>
                        </li>
                        <? }
                                            else
                                            { ?>
                        <li>
                            <a href="javascript:void(0);" data-toggle="modal" data-target="#myModal1">
                                <span
                                    class="glyphicon glyphicon-earphone icon-circle border border-dark-blue with-text"></span>Mobile</a>
                        </li>
                        <? }
                                        } ?>
                        ...
                        <li>
                            <a href="mailto:<?=$list['email']?>">
                                <span
                                    class="glyphicon glyphicon-envelope icon-circle border border-dark-blue with-text"></span>Email</a>
                        </li>
                        <? } ?>
                        ...
                        <li>
                            <a href="<?=$list['website']?>" target="_blank">
                                <span
                                    class="glyphicon glyphicon-globe icon-circle border border-dark-blue with-text"></span>Website</a>
                        </li>
                        <?}?>
                        ...
                        <li>
                            <a href="javascript:void(0);" data-toggle="modal" data-target="#myModal3"
                                data-id="<?=$list['whatsup']?>" id="openwhatsapp">
                                <span
                                    class="glyphicon glyphicon-phone icon-circle border border-dark-blue with-text"></span>Whatsapp</a>
                        </li>
                        <? }
                                            else
                                            { ?>
                        <li>
                            <a href="javascript:void(0);" data-toggle="modal" data-target="#myModal1">
                                <span
                                    class="glyphicon glyphicon-phone icon-circle border border-dark-blue with-text"></span></span>Whatsapp</a>
                        </li>
                        <? }
                                        } ?>
                        ...
                        <? if(isset($list['facebook']) && $list['facebook']!='')
                                        {?>
                        <li>
                            <a href="<?=$list['facebook']?>" target="_blank"> <span
                                    class="glyphicon glyphicon-user icon-circle border border-dark-blue with-text"></span>Facebook/Instagram</a>
                        </li>
                        <?}?>
                        ...
                        <a href="javascript:void(0);" class="whislistbtn"
                            onclick="remove_wishlist('<?=$list['id']?>','<?=$this->session->userdata('id')?>');">
                            Wishlisted </a>
                        <?php }else
                                            { ?>
                        <a href="javascript:void(0);" class="whislistbtn"
                            onclick="add_wishlist('<?=$list['id']?>','<?=$this->session->userdata('id')?>');"> Add to
                            Wishlist </a>
                        <?php }?>

                        <?php }else{?>
                        <a href="javascript:void(0);" data-toggle="modal" data-target="#myModal" class="whislistbtn"
                            onclick="hideregisterdiv();">Add to Wish List</a>
                        <?php }?>
                    ...
                    <ul class="list_btm_area">
                        ...
                        <?}?>
                         ...
                         <div class="introvideo">
                                    <? if(isset($list['intro_video']) && $list['intro_video']!='')
                                        {?>
                                        <a class="whislistbtn"  data-toggle="modal" data-target="#introvideo_modal"> Introduction Video </a>
                                            ...
                                            <center><h4 class="modal-title" id="myModalLabel">Introduction Video</h4></center>
                                            </div>
                                            <div class="modal-body">
                                            <iframe type="text/html" height="380" src="<?= $list['intro_video'];?>" frameborder="0" allowfullscreen="" style="width:100% !important"></iframe>
                                            </div>
